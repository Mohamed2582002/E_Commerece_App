...
class AppStyles{
  ...
  static TextStyle regular14SearchHint = GoogleFonts.poppins(
  ...
  static TextStyle light18Hint = GoogleFonts.poppins(
  ...
  static TextStyle medium14LightPrimary = GoogleFonts.poppins(
      fontSize: 14,fontWeight: FontWeight.w500,color: AppColors.lightBlack );
